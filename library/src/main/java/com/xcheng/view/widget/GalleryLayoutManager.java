...
import com.xcheng.view.BuildConfig;
...
public class GalleryLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private float smoothTimeRate = 1;

    public void setSmoothTimeRate(float smoothTimeRate) {
        this.smoothTimeRate = smoothTimeRate;
    }
    ...
    private class GallerySmoothScroller extends LinearSmoothScroller {
        ...
        protected void onTargetFound(View targetView, RecyclerView.State state, Action action) {
            ...
            final int time = (int) (calculateTimeForDeceleration(distance) * smoothTimeRate);
            if (time > 0) {
